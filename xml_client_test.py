...
class xml_client_test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, freq='Initialising', ip='127.0.0.1'):
        ...
        labels = ['Signal 1', 'Signal 2', 'RX', 'Signal 4', 'Signal 5',
        ...
        self.qtgui_number_sink_0.set_title("Reflection difference")
        ...
        for i in range(1):
            ...
            self.qtgui_number_sink_0.set_max(i, 5000)
        ...
        self.network_tcp_source_2_0 = network.tcp_source.tcp_source(itemsize=gr.sizeof_float*1,addr=ip,port=6002,server=False)
        self.network_tcp_source_2 = network.tcp_source.tcp_source(itemsize=gr.sizeof_float*1,addr=ip,port=6001,server=False)
        self.network_tcp_source_1 = network.tcp_source.tcp_source(itemsize=gr.sizeof_gr_complex*1,addr=ip,port=6004,server=False)
        self.network_tcp_source_0 = network.tcp_source.tcp_source(itemsize=gr.sizeof_gr_complex*1,addr=ip,port=6003,server=False)
        self.epy_block_2_0 = epy_block_2_0.blk(freq=0)
        ...
        self.connect((self.network_tcp_source_0, 0), (self.qtgui_time_sink_x_0, 1))
        self.connect((self.network_tcp_source_1, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.network_tcp_source_2, 0), (self.qtgui_number_sink_0, 0))
        self.connect((self.network_tcp_source_2_0, 0), (self.epy_block_2_0, 0))
